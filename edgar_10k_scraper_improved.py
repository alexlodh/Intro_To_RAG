#!/usr/bin/env python3
"""
edgar_10k_scraper_improved.py

This script searches for recent 10-K filings using the SEC EDGAR Company Facts API
and attempts to download them using proper SEC EDGAR endpoints.

Dependencies:
    pip install requests beautifulsoup4

Usage:
    python edgar_10k_scraper_improved.py
"""
...
def main():
    """
    Main function to demonstrate the scraper with a few well-known companies.
    """
    # Some well-known company CIKs for testing
    test_companies = [
    ...
    print("Testing SEC EDGAR 10-K scraper...")
    ...
    for company in test_companies:
        ...
        ten_k_filings = find_recent_10k_filings(filings_data, limit=2)
        ...
        for filing in ten_k_filings:
            ...
            if doc_url:
                ...
                download_document(doc_url, filename)
            else:
